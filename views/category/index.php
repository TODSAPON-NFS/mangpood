            ...
            bootbox.dialog({
                  ...
                  buttons: {
                    success: {
                      ...
                      callback: function() {
                            $.post("' . Url::toRoute([\app\models\Category::CONTROLLER_ACTION_DELETEALL]) . '",{ids:keys.join()});
                        },
                      },
                    close: {
                        label: "ปิด",
...
<div class="category-index">
    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            return '<span class="label label-pill label-primary" style="background-color:#ff6600;">ID : ' . $model->category_id . '</span> ' . Html::a('<strong>' . $model->category_name . '</strong>', [\app\models\Category::CONTROLLER_ACTION_VIEW, "id" => $model->category_id], ["data-pjax"=>"0"]);
        }
            ],
            [
